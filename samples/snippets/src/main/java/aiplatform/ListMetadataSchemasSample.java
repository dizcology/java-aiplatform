...
public class ListMetadataSchemasSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    listMetadataSchemasSample(project, location, metadataStoreId);
  }

  static void listMetadataSchemasSample(String project, String location, String metadataStoreId)
      throws IOException {
    ...
    try (MetadataServiceClient client = MetadataServiceClient.create(settings)) {
      ...
      for (MetadataSchema metadataSchema : client.listMetadataSchemas(parent).iterateAll()) {
        System.out.format("metadataSchema: %s\n", metadataSchema);
      }
    }
  }
}
