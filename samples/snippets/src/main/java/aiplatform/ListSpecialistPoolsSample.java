...
public class ListSpecialistPoolsSample {

  public static void main(String[] args) throws IOException {
    // TODO(developer): Replace these variables before running the sample.
    String project = "PROJECT";
    String location = "us-central1";
    listSpecialistPoolsSample(project, location);
  }

  static void listSpecialistPoolsSample(String project, String location) throws IOException {
    ...
    try (SpecialistPoolServiceClient client = SpecialistPoolServiceClient.create(settings)) {
      ...
      for (SpecialistPool specialistPool : client.listSpecialistPools(parent).iterateAll()) {
        System.out.format("specialistPool: %s\n", specialistPool);
      }
    }
  }
}
