...
public class GetFeaturestoreSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    getFeaturestoreSample(project, location, featurestoreId);
  }

  static void getFeaturestoreSample(String project, String location, String featurestoreId)
      throws IOException {
    ...
    try (FeaturestoreServiceClient client = FeaturestoreServiceClient.create(settings)) {
      FeaturestoreName name = FeaturestoreName.of(project, location, featurestoreId);
      Featurestore response = client.getFeaturestore(name);
