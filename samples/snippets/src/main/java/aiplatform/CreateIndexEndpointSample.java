...
public class CreateIndexEndpointSample {
  ...
  public static void main(String[] args)
    ...
    createIndexEndpointSample(project, location, displayName);
  }

  static void createIndexEndpointSample(String project, String location, String displayName)
      throws IOException, ExecutionException, InterruptedException {
    ...
    try (IndexEndpointServiceClient client = IndexEndpointServiceClient.create(settings)) {
      IndexEndpoint indexEndpoint = IndexEndpoint.newBuilder().setDisplayName(displayName).build();
      LocationName parent = LocationName.of(project, location);
      OperationFuture<IndexEndpoint, CreateIndexEndpointOperationMetadata> response =
          client.createIndexEndpointAsync(parent, indexEndpoint);
      ...
      IndexEndpoint createdIndexEndpoint = response.get();
      System.out.format("createdIndexEndpoint: %s\n", createdIndexEndpoint);
    }
  }
}
