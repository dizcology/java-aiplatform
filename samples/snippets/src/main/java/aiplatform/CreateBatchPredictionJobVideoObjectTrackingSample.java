...
public class CreateBatchPredictionJobVideoObjectTrackingSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    createBatchPredictionJobVideoObjectTrackingSample(
        project, location, displayName, modelId, gcsSourceUri, gcsDestinationOutputUriPrefix);
  }

  static void createBatchPredictionJobVideoObjectTrackingSample(
      String project,
      String location,
      String displayName,
      String modelId,
    ...
    try (JobServiceClient client = JobServiceClient.create(settings)) {
      ...
      jsonModelParameters.addProperty("confidenceThreshold", 0.0);
