...
// [START aiplatform_get_study_sample]
...
public class GetStudySample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    getStudySample(project, location, studyId);
  }

  static void getStudySample(String project, String location, String studyId) throws IOException {
    ...
    try (VizierServiceClient client = VizierServiceClient.create(settings)) {
      StudyName name = StudyName.of(project, location, studyId);
      Study response = client.getStudy(name);
      System.out.format("response: %s\n", response);
    }
  }
}

// [END aiplatform_get_study_sample]
