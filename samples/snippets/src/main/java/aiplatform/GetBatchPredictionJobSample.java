...
public class GetBatchPredictionJobSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    getBatchPredictionJobSample(project, location, batchPredictionJobId);
  }

  static void getBatchPredictionJobSample(
      String project, String location, String batchPredictionJobId) throws IOException {
    ...
    try (JobServiceClient client = JobServiceClient.create(settings)) {
      ...
      BatchPredictionJob response = client.getBatchPredictionJob(name);
