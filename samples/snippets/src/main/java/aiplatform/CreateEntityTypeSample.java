...
public class CreateEntityTypeSample {
  ...
  public static void main(String[] args)
    ...
    createEntityTypeSample(project, location, featurestoreId, description);
  }

  static void createEntityTypeSample(
      String project, String location, String featurestoreId, String description)
      throws IOException, ExecutionException, InterruptedException {
    ...
    try (FeaturestoreServiceClient client = FeaturestoreServiceClient.create(settings)) {
      ...
      OperationFuture<EntityType, CreateEntityTypeOperationMetadata> response =
          client.createEntityTypeAsync(parent, entityType);
      ...
      EntityType createdEntityType = response.get();
      System.out.format("createdEntityType: %s\n", createdEntityType);
    }
  }
}
