...
public class DeleteFeatureSample {
  ...
  public static void main(String[] args)
    ...
    deleteFeatureSample(project, location, featurestoreId, entityTypeId, featureId);
  }

  static void deleteFeatureSample(
      String project, String location, String featurestoreId, String entityTypeId, String featureId)
      throws IOException, ExecutionException, InterruptedException {
    ...
    try (FeaturestoreServiceClient client = FeaturestoreServiceClient.create(settings)) {
      FeatureName name = FeatureName.of(project, location, featurestoreId, entityTypeId, featureId);
      OperationFuture<Empty, DeleteOperationMetadata> response = client.deleteFeatureAsync(name);
