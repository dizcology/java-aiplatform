...
public class DeleteTrainingPipelineSample {
  ...
  public static void main(String[] args)
    ...
    deleteTrainingPipelineSample(project, location, trainingPipelineId);
  }

  static void deleteTrainingPipelineSample(
      String project, String location, String trainingPipelineId)
      throws IOException, ExecutionException, InterruptedException {
    ...
    try (PipelineServiceClient client = PipelineServiceClient.create(settings)) {
      ...
      OperationFuture<Empty, DeleteOperationMetadata> response =
          client.deleteTrainingPipelineAsync(name);
