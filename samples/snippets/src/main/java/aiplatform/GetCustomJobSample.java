...
public class GetCustomJobSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    getCustomJobSample(project, location, customJobId);
  }

  static void getCustomJobSample(String project, String location, String customJobId)
      throws IOException {
    ...
    try (JobServiceClient client = JobServiceClient.create(settings)) {
      ...
      CustomJob response = client.getCustomJob(name);
