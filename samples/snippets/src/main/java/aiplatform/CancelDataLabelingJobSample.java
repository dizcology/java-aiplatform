...
public class CancelDataLabelingJobSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    cancelDataLabelingJobSample(project, location, dataLabelingJobId);
  }

  static void cancelDataLabelingJobSample(String project, String location, String dataLabelingJobId)
      throws IOException {
