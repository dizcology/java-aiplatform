...
public class DeleteTensorboardTimeSeriesSample {
  ...
  public static void main(String[] args)
    ...
    deleteTensorboardTimeSeriesSample(
        project, location, tensorboardId, experimentId, runId, timeSeriesId);
  }

  static void deleteTensorboardTimeSeriesSample(
      String project,
      String location,
    ...
    try (TensorboardServiceClient client = TensorboardServiceClient.create(settings)) {
      ...
      OperationFuture<Empty, DeleteOperationMetadata> response =
          client.deleteTensorboardTimeSeriesAsync(name);
