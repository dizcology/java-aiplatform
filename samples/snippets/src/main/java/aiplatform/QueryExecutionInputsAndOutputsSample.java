...
public class QueryExecutionInputsAndOutputsSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    queryExecutionInputsAndOutputsSample(project, location, metadataStoreId, executionId);
  }

  static void queryExecutionInputsAndOutputsSample(
      String project, String location, String metadataStoreId, String executionId)
      throws IOException {
    ...
    try (MetadataServiceClient client = MetadataServiceClient.create(settings)) {
      ...
      LineageSubgraph response = client.queryExecutionInputsAndOutputs(execution);
