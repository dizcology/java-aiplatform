...
public class DeleteEndpointSample {
  ...
  public static void main(String[] args)
    ...
    deleteEndpointSample(project, location, endpointId);
  }

  static void deleteEndpointSample(String project, String location, String endpointId)
      throws IOException, ExecutionException, InterruptedException {
    ...
    try (EndpointServiceClient client = EndpointServiceClient.create(settings)) {
      ...
      OperationFuture<Empty, DeleteOperationMetadata> response = client.deleteEndpointAsync(name);
