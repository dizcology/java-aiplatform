...
public class DeleteEntityTypeSample {
  ...
  public static void main(String[] args)
    ...
    deleteEntityTypeSample(project, location, featurestoreId, entityTypeId);
  }
  ...
  static void deleteEntityTypeSample(
    ...
    try (FeaturestoreServiceClient client = FeaturestoreServiceClient.create(settings)) {
      ...
      OperationFuture<Empty, DeleteOperationMetadata> response = client.deleteEntityTypeAsync(name);
