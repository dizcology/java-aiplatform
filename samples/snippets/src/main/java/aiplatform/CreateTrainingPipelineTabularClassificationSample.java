...
public class CreateTrainingPipelineTabularClassificationSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    createTrainingPipelineTabularClassificationSample(
        project, location, displayName, datasetId, modelDisplayName, targetColumn);
  }

  static void createTrainingPipelineTabularClassificationSample(
      String project,
      String location,
      String displayName,
      String datasetId,
    ...
    try (PipelineServiceClient client = PipelineServiceClient.create(settings)) {
      ...
      jsonTrainingTaskInputs.addProperty("predictionType", "classification");
      ...
      // minimize-log-loss
      jsonTrainingTaskInputs.addProperty("optimizationObjective", "minimize-log-loss");
