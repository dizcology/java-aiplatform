...
public class ListExecutionsSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    listExecutionsSample(project, location, metadataStoreId);
  }

  static void listExecutionsSample(String project, String location, String metadataStoreId)
      throws IOException {
    ...
    try (MetadataServiceClient client = MetadataServiceClient.create(settings)) {
      ...
      for (Execution execution : client.listExecutions(parent).iterateAll()) {
