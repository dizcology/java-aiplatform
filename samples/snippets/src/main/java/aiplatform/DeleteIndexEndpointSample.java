...
public class DeleteIndexEndpointSample {
  ...
  public static void main(String[] args)
    ...
    deleteIndexEndpointSample(project, location, indexEndpointId);
  }

  static void deleteIndexEndpointSample(String project, String location, String indexEndpointId)
      throws IOException, ExecutionException, InterruptedException {
