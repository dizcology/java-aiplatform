...
public class ImportDataImageClassificationSingleLabelSample {
  ...
  public static void main(String[] args)
    ...
    importDataImageClassificationSingleLabelSample(project, location, datasetId, gcsSourceUri);
  }

  static void importDataImageClassificationSingleLabelSample(
