...
public class DeleteBatchPredictionJobSample {
  ...
  public static void main(String[] args)
    ...
    String batchPredictionJobId = "BATCH_PREDICTION_JOB_ID";
    deleteBatchPredictionJobSample(project, location, batchPredictionJobId);
  }

  static void deleteBatchPredictionJobSample(
      String project, String location, String batchPredictionJobId)
      throws IOException, ExecutionException, InterruptedException {
    ...
    try (JobServiceClient client = JobServiceClient.create(settings)) {
      ...
      OperationFuture<Empty, DeleteOperationMetadata> response =
          client.deleteBatchPredictionJobAsync(name);
