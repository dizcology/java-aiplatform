...
public class GetModelDeploymentMonitoringJobSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    getModelDeploymentMonitoringJobSample(project, location, modelDeploymentMonitoringJobId);
  }

  static void getModelDeploymentMonitoringJobSample(
    ...
    try (JobServiceClient client = JobServiceClient.create(settings)) {
      ...
      ModelDeploymentMonitoringJob response = client.getModelDeploymentMonitoringJob(name);
