...
public class ImportFeatureValuesSample {
  ...
  public static void main(String[] args)
    ...
    importFeatureValuesSample(project, location, featurestoreId, entityTypeId);
  }
  ...
  static void importFeatureValuesSample(
    ...
    try (FeaturestoreServiceClient client = FeaturestoreServiceClient.create(settings)) {
      ...
      OperationFuture<ImportFeatureValuesResponse, ImportFeatureValuesOperationMetadata> response =
          client.importFeatureValuesAsync(entityType);
      ...
      ImportFeatureValuesResponse importFeatureValuesResponse = response.get();
      System.out.format("importFeatureValuesResponse: %s\n", importFeatureValuesResponse);
    }
  }
}
