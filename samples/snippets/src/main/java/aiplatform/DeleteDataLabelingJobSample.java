...
public class DeleteDataLabelingJobSample {
  ...
  public static void main(String[] args)
    ...
    deleteDataLabelingJobSample(project, location, dataLabelingJobId);
  }

  static void deleteDataLabelingJobSample(String project, String location, String dataLabelingJobId)
      throws IOException, ExecutionException, InterruptedException {
    ...
    try (JobServiceClient client = JobServiceClient.create(settings)) {
      ...
      OperationFuture<Empty, DeleteOperationMetadata> response =
          client.deleteDataLabelingJobAsync(name);
