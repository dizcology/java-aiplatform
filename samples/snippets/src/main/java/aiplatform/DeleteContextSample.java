...
public class DeleteContextSample {
  ...
  public static void main(String[] args)
    ...
    deleteContextSample(project, location, metadataStoreId, contextId);
  }

  static void deleteContextSample(
      String project, String location, String metadataStoreId, String contextId)
      throws IOException, ExecutionException, InterruptedException {
    ...
    try (MetadataServiceClient client = MetadataServiceClient.create(settings)) {
      ContextName name = ContextName.of(project, location, metadataStoreId, contextId);
      OperationFuture<Empty, DeleteOperationMetadata> response = client.deleteContextAsync(name);
