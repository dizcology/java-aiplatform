...
public class ListFeaturestoresSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    listFeaturestoresSample(project, location);
  }

  static void listFeaturestoresSample(String project, String location) throws IOException {
    ...
    try (FeaturestoreServiceClient client = FeaturestoreServiceClient.create(settings)) {
      ...
      for (Featurestore featurestore : client.listFeaturestores(parent).iterateAll()) {
        System.out.format("featurestore: %s\n", featurestore);
      }
    }
  }
}
