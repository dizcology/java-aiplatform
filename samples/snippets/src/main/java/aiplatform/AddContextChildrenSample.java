...
public class AddContextChildrenSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    String childContext = "CHILD_CONTEXT";
    addContextChildrenSample(project, location, metadataStoreId, contextId, childContext);
  }

  static void addContextChildrenSample(
      String project,
      String location,
    ...
    try (MetadataServiceClient client = MetadataServiceClient.create(settings)) {
      ...
      AddContextChildrenResponse response = client.addContextChildren(context, childContexts);
