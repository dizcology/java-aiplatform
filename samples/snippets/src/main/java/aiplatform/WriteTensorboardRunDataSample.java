...
public class WriteTensorboardRunDataSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    String runId = "RUN_ID";
    String tensorboardTimeSeriesId = "TENSORBOARD_TIME_SERIES_ID";
    writeTensorboardRunDataSample(
        project, location, tensorboardId, experimentId, runId, tensorboardTimeSeriesId);
  }

  static void writeTensorboardRunDataSample(
      String project,
      String location,
    ...
    try (TensorboardServiceClient client = TensorboardServiceClient.create(settings)) {
      TimeSeriesData timeSeriesDatum0 =
          TimeSeriesData.newBuilder().setTensorboardTimeSeriesId(tensorboardTimeSeriesId).build();
      List<TimeSeriesData> timeSeriesData = new ArrayList<>();
      timeSeriesData.add(timeSeriesDatum0);
