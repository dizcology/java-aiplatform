...
public class CreateBatchPredictionJobCustomImageExplainSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    createBatchPredictionJobCustomImageExplainSample(
        project,
        location,
        displayName,
        modelId,
  ...
  static void createBatchPredictionJobCustomImageExplainSample(
      String project,
      String location,
      String displayName,
      String modelId,
