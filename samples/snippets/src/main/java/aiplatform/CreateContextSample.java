...
public class CreateContextSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    createContextSample(project, location, metadataStoreId, displayName, contextId);
  }

  static void createContextSample(
      String project, String location, String metadataStoreId, String displayName, String contextId)
      throws IOException {
    ...
    try (MetadataServiceClient client = MetadataServiceClient.create(settings)) {
      Context context = Context.newBuilder().setDisplayName(displayName).build();
      MetadataStoreName parent = MetadataStoreName.of(project, location, metadataStoreId);
      Context response = client.createContext(parent, context, contextId);
