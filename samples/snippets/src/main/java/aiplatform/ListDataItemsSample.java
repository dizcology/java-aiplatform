...
public class ListDataItemsSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    listDataItemsSample(project, location, datasetId);
  }

  static void listDataItemsSample(String project, String location, String datasetId)
      throws IOException {
    ...
    try (DatasetServiceClient client = DatasetServiceClient.create(settings)) {
      DatasetName parent = DatasetName.of(project, location, datasetId);
      for (DataItem dataItem : client.listDataItems(parent).iterateAll()) {
        System.out.format("dataItem: %s\n", dataItem);
      }
    }
  }
}
