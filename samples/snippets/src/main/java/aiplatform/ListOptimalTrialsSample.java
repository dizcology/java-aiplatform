...
public class ListOptimalTrialsSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    listOptimalTrialsSample(project, location, studyId);
  }

  static void listOptimalTrialsSample(String project, String location, String studyId)
      throws IOException {
    ...
    try (VizierServiceClient client = VizierServiceClient.create(settings)) {
      ...
      ListOptimalTrialsResponse response = client.listOptimalTrials(parent);
