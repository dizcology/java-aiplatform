...
public class CreateMetadataSchemaSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    createMetadataSchemaSample(project, location, metadataStoreId, schema, metadataSchemaId);
  }

  static void createMetadataSchemaSample(
      String project,
      String location,
    ...
    try (MetadataServiceClient client = MetadataServiceClient.create(settings)) {
      MetadataSchema metadataSchema = MetadataSchema.newBuilder().setSchema(schema).build();
