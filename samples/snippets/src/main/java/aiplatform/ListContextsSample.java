...
// [START aiplatform_list_contexts_sample]
...
public class ListContextsSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    listContextsSample(project, location, metadataStoreId);
  }

  static void listContextsSample(String project, String location, String metadataStoreId)
      throws IOException {
    ...
    try (MetadataServiceClient client = MetadataServiceClient.create(settings)) {
      ...
      for (Context context : client.listContexts(parent).iterateAll()) {
...
// [END aiplatform_list_contexts_sample]
