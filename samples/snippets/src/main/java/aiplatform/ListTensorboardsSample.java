...
// [START aiplatform_list_tensorboards_sample]
...
public class ListTensorboardsSample {

  public static void main(String[] args) throws IOException {
    // TODO(developer): Replace these variables before running the sample.
    String project = "PROJECT";
    String location = "us-central1";
    listTensorboardsSample(project, location);
  }

  static void listTensorboardsSample(String project, String location) throws IOException {
    ...
    try (TensorboardServiceClient client = TensorboardServiceClient.create(settings)) {
      ...
      for (Tensorboard tensorboard : client.listTensorboards(parent).iterateAll()) {
        System.out.format("tensorboard: %s\n", tensorboard);
      }
    }
  }
}

// [END aiplatform_list_tensorboards_sample]
