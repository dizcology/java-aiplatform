...
public class CreateCustomJobPythonPackageSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    String packageExecutorImageUri = "PACKAGE_EXECUTOR_IMAGE_URI";
    String gcsPythonPackageUri = "GCS_PYTHON_PACKAGE_URI";
    createCustomJobPythonPackageSample(
        project, location, displayName, packageExecutorImageUri, gcsPythonPackageUri);
  }

  static void createCustomJobPythonPackageSample(
      String project,
      String location,
      String displayName,
      String packageExecutorImageUri,
      String gcsPythonPackageUri)
      throws IOException {
    ...
    try (JobServiceClient client = JobServiceClient.create(settings)) {
      ...
      PythonPackageSpec pythonPackageSpec =
          PythonPackageSpec.newBuilder()
              .setExecutorImageUri(packageExecutorImageUri)
              .addPackageUris(gcsPythonPackageUri)
              .build();
