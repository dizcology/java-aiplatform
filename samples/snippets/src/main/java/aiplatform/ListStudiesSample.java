...
// [START aiplatform_list_studies_sample]
...
public class ListStudiesSample {

  public static void main(String[] args) throws IOException {
    // TODO(developer): Replace these variables before running the sample.
    String project = "PROJECT";
    String location = "us-central1";
    listStudiesSample(project, location);
  }

  static void listStudiesSample(String project, String location) throws IOException {
    ...
    try (VizierServiceClient client = VizierServiceClient.create(settings)) {
      ...
      for (Study study : client.listStudies(parent).iterateAll()) {
        System.out.format("study: %s\n", study);
      }
    }
  }
}

// [END aiplatform_list_studies_sample]
