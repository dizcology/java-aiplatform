...
import com.google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlTextExtractionInputs;
...
public class CreateTrainingPipelineTextEntityExtractionSample {
  ...
  static void createTrainingPipelineTextEntityExtractionSample(
    ...
    try (PipelineServiceClient client = PipelineServiceClient.create(settings)) {
      AutoMlTextExtractionInputs trainingTaskInputs =
          AutoMlTextExtractionInputs.newBuilder().build();
