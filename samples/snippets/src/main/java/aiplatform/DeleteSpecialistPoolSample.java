...
public class DeleteSpecialistPoolSample {
  ...
  public static void main(String[] args)
    ...
    deleteSpecialistPoolSample(project, location, specialistPoolId);
  }

  static void deleteSpecialistPoolSample(String project, String location, String specialistPoolId)
      throws IOException, ExecutionException, InterruptedException {
    ...
    try (SpecialistPoolServiceClient client = SpecialistPoolServiceClient.create(settings)) {
      ...
      OperationFuture<Empty, DeleteOperationMetadata> response =
          client.deleteSpecialistPoolAsync(name);
