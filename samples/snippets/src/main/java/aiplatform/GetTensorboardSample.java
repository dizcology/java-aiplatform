...
public class GetTensorboardSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    getTensorboardSample(project, location, tensorboardId);
  }

  static void getTensorboardSample(String project, String location, String tensorboardId)
      throws IOException {
    ...
    try (TensorboardServiceClient client = TensorboardServiceClient.create(settings)) {
      ...
      Tensorboard response = client.getTensorboard(name);
