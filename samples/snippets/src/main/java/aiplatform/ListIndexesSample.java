...
// [START aiplatform_list_indexes_sample]
...
public class ListIndexesSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    listIndexesSample(project, location);
  }

  static void listIndexesSample(String project, String location) throws IOException {
    ...
    try (IndexServiceClient client = IndexServiceClient.create(settings)) {
      ...
      for (Index index : client.listIndexes(parent).iterateAll()) {
...
// [END aiplatform_list_indexes_sample]
