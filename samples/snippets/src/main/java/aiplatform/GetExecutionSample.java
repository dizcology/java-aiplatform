...
public class GetExecutionSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    getExecutionSample(project, location, metadataStoreId, executionId);
  }

  static void getExecutionSample(
    ...
    try (MetadataServiceClient client = MetadataServiceClient.create(settings)) {
      ExecutionName name = ExecutionName.of(project, location, metadataStoreId, executionId);
      Execution response = client.getExecution(name);
