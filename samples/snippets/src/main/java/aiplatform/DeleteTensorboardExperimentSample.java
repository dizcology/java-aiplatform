...
// [START aiplatform_delete_tensorboard_experiment_sample]
...
public class DeleteTensorboardExperimentSample {
  ...
  public static void main(String[] args)
    ...
    deleteTensorboardExperimentSample(project, location, tensorboardId, experimentId);
  }

  static void deleteTensorboardExperimentSample(
    ...
    try (TensorboardServiceClient client = TensorboardServiceClient.create(settings)) {
      ...
      OperationFuture<Empty, DeleteOperationMetadata> response =
          client.deleteTensorboardExperimentAsync(name);
...
// [END aiplatform_delete_tensorboard_experiment_sample]
