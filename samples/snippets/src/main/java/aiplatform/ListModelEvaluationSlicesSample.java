...
public class ListModelEvaluationSlicesSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    listModelEvaluationSlicesSample(project, location, modelId, evaluationId);
  }

  static void listModelEvaluationSlicesSample(
    ...
    try (ModelServiceClient client = ModelServiceClient.create(settings)) {
      ModelEvaluationName parent = ModelEvaluationName.of(project, location, modelId, evaluationId);
      for (ModelEvaluationSlice modelEvaluationSlice :
          client.listModelEvaluationSlices(parent).iterateAll()) {
        System.out.format("modelEvaluationSlice: %s\n", modelEvaluationSlice);
      }
    }
  }
}
