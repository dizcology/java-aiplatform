...
public class DeleteFeaturestoreSample {
  ...
  public static void main(String[] args)
    ...
    deleteFeaturestoreSample(project, location, featurestoreId);
  }

  static void deleteFeaturestoreSample(String project, String location, String featurestoreId)
      throws IOException, ExecutionException, InterruptedException {
    ...
    try (FeaturestoreServiceClient client = FeaturestoreServiceClient.create(settings)) {
      ...
      OperationFuture<Empty, DeleteOperationMetadata> response =
          client.deleteFeaturestoreAsync(name);
