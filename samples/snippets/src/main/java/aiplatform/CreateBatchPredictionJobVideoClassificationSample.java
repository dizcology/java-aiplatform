...
public class CreateBatchPredictionJobVideoClassificationSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    createBatchPredictionJobVideoClassificationSample(
        project, location, displayName, modelId, gcsSourceUri, gcsDestinationOutputUriPrefix);
  }

  static void createBatchPredictionJobVideoClassificationSample(
      String project,
      String location,
      String displayName,
      String modelId,
    ...
    try (JobServiceClient client = JobServiceClient.create(settings)) {
      ...
      jsonModelParameters.addProperty("maxPredictions", 10000);
      jsonModelParameters.addProperty("segmentClassification", true);
      jsonModelParameters.addProperty("shotClassification", true);
      jsonModelParameters.addProperty("oneSecIntervalClassification", true);
