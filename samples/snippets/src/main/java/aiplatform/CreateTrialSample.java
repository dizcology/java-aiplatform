...
public class CreateTrialSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    createTrialSample(project, location, studyId);
  }

  static void createTrialSample(String project, String location, String studyId)
      throws IOException {
    ...
    try (VizierServiceClient client = VizierServiceClient.create(settings)) {
      ...
      Trial response = client.createTrial(parent, trial);
