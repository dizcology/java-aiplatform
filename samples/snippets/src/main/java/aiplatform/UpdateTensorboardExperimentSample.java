...
public class UpdateTensorboardExperimentSample {

  public static void main(String[] args) throws IOException {
    // TODO(developer): Replace these variables before running the sample.
    String name = "NAME";
    String displayName = "DISPLAY_NAME";
    updateTensorboardExperimentSample(name, displayName);
  }

  static void updateTensorboardExperimentSample(String name, String displayName)
      throws IOException {
    ...
    try (TensorboardServiceClient client = TensorboardServiceClient.create(settings)) {
      TensorboardExperiment tensorboardExperiment =
          TensorboardExperiment.newBuilder().setName(name).setDisplayName(displayName).build();
