...
// [START aiplatform_delete_tensorboard_sample]
...
public class DeleteTensorboardSample {
  ...
  public static void main(String[] args)
    ...
    deleteTensorboardSample(project, location, tensorboardId);
  }

  static void deleteTensorboardSample(String project, String location, String tensorboardId)
      throws IOException, ExecutionException, InterruptedException {
    ...
    try (TensorboardServiceClient client = TensorboardServiceClient.create(settings)) {
      TensorboardName name = TensorboardName.of(project, location, tensorboardId);
      OperationFuture<Empty, DeleteOperationMetadata> response =
          client.deleteTensorboardAsync(name);
...
// [END aiplatform_delete_tensorboard_sample]
