...
// [START aiplatform_upload_model_managed_container_sample]
...
public class UploadModelManagedContainerSample {
  ...
  public static void main(String[] args)
    ...
    String containerSpecImageUri = "CONTAINER_SPEC_IMAGE_URI";
    String artifactUri = "ARTIFACT_URI";
    uploadModelManagedContainerSample(
        project, location, displayName, containerSpecImageUri, artifactUri);
  }

  static void uploadModelManagedContainerSample(
      String project,
      String location,
      String displayName,
      String containerSpecImageUri,
      String artifactUri)
      throws IOException, ExecutionException, InterruptedException {
    ...
    try (ModelServiceClient client = ModelServiceClient.create(settings)) {
      ModelContainerSpec containerSpec =
          ModelContainerSpec.newBuilder().setImageUri(containerSpecImageUri).build();
      Model model =
          Model.newBuilder()
...
// [END aiplatform_upload_model_managed_container_sample]
