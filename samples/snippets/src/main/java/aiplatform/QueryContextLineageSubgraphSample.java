...
public class QueryContextLineageSubgraphSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    queryContextLineageSubgraphSample(project, location, metadataStoreId, contextId);
  }

  static void queryContextLineageSubgraphSample(
    ...
    try (MetadataServiceClient client = MetadataServiceClient.create(settings)) {
      ...
      LineageSubgraph response = client.queryContextLineageSubgraph(context);
