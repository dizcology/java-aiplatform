...
public class CreateArtifactSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    createArtifactSample(project, location, metadataStoreId, displayName, artifactId);
  }

  static void createArtifactSample(
      String project,
      String location,
    ...
    try (MetadataServiceClient client = MetadataServiceClient.create(settings)) {
      Artifact artifact = Artifact.newBuilder().setDisplayName(displayName).build();
      MetadataStoreName parent = MetadataStoreName.of(project, location, metadataStoreId);
      Artifact response = client.createArtifact(parent, artifact, artifactId);
