...
public class CreateExecutionSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    createExecutionSample(project, location, metadataStoreId, displayName, executionId);
  }

  static void createExecutionSample(
      String project,
      String location,
    ...
    try (MetadataServiceClient client = MetadataServiceClient.create(settings)) {
      Execution execution = Execution.newBuilder().setDisplayName(displayName).build();
      MetadataStoreName parent = MetadataStoreName.of(project, location, metadataStoreId);
      Execution response = client.createExecution(parent, execution, executionId);
