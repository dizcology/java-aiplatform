...
public class QueryArtifactLineageSubgraphSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    queryArtifactLineageSubgraphSample(project, location, metadataStoreId, artifactId);
  }

  static void queryArtifactLineageSubgraphSample(
    ...
    try (MetadataServiceClient client = MetadataServiceClient.create(settings)) {
      ArtifactName artifact = ArtifactName.of(project, location, metadataStoreId, artifactId);
      LineageSubgraph response = client.queryArtifactLineageSubgraph(artifact);
