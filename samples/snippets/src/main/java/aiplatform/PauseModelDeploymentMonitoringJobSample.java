...
public class PauseModelDeploymentMonitoringJobSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    pauseModelDeploymentMonitoringJobSample(project, location, modelDeploymentMonitoringJobId);
  }

  static void pauseModelDeploymentMonitoringJobSample(
