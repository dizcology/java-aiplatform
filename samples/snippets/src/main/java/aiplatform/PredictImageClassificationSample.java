...
public class PredictImageClassificationSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    predictImageClassificationSample(project, location, endpointId, filename);
  }

  static void predictImageClassificationSample(
    ...
    try (PredictionServiceClient client = PredictionServiceClient.create(settings)) {
      ...
      ImageClassificationPredictionInstance instance =
          ImageClassificationPredictionInstance.newBuilder().setContent(encodedContent).build();
      ...
      ImageClassificationPredictionParams parameters =
