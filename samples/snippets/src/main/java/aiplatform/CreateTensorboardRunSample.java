...
public class CreateTensorboardRunSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    String tensorboardRunId = "TENSORBOARD_RUN_ID";
    createTensorboardRunSample(
        project, location, tensorboardId, experimentId, runId, displayName, tensorboardRunId);
  }

  static void createTensorboardRunSample(
      String project,
      String location,
    ...
    try (TensorboardServiceClient client = TensorboardServiceClient.create(settings)) {
      TensorboardRun tensorboardRun =
          TensorboardRun.newBuilder().setDisplayName(displayName).build();
