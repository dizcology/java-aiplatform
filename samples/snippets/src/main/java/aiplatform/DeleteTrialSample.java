...
public class DeleteTrialSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    deleteTrialSample(project, location, studyId, trialId);
  }

  static void deleteTrialSample(String project, String location, String studyId, String trialId)
      throws IOException {
