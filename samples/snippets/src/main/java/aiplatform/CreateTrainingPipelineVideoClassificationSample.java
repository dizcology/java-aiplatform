...
import com.google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlVideoClassificationInputs;
...
public class CreateTrainingPipelineVideoClassificationSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    createTrainingPipelineVideoClassificationSample(
        project, location, displayName, datasetId, modelDisplayName);
  }

  static void createTrainingPipelineVideoClassificationSample(
      String project,
      String location,
      String displayName,
      String datasetId,
    ...
    try (PipelineServiceClient client = PipelineServiceClient.create(settings)) {
      AutoMlVideoClassificationInputs trainingTaskInputs =
          AutoMlVideoClassificationInputs.newBuilder().build();
