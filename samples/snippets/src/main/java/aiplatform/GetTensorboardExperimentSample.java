...
// [START aiplatform_get_tensorboard_experiment_sample]
...
public class GetTensorboardExperimentSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    getTensorboardExperimentSample(project, location, tensorboardId, experimentId);
  }

  static void getTensorboardExperimentSample(
    ...
    try (TensorboardServiceClient client = TensorboardServiceClient.create(settings)) {
      ...
      TensorboardExperiment response = client.getTensorboardExperiment(name);
      System.out.format("response: %s\n", response);
    }
  }
}

// [END aiplatform_get_tensorboard_experiment_sample]
