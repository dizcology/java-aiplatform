...
public class CancelTrainingPipelineSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    cancelTrainingPipelineSample(project, location, trainingPipelineId);
  }

  static void cancelTrainingPipelineSample(
      String project, String location, String trainingPipelineId) throws IOException {
