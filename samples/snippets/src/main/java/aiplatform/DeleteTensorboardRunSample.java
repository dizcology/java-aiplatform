...
public class DeleteTensorboardRunSample {
  ...
  public static void main(String[] args)
    ...
    String runId = "RUN_ID";
    deleteTensorboardRunSample(project, location, tensorboardId, experimentId, runId);
  }

  static void deleteTensorboardRunSample(
    ...
    try (TensorboardServiceClient client = TensorboardServiceClient.create(settings)) {
      ...
      OperationFuture<Empty, DeleteOperationMetadata> response =
          client.deleteTensorboardRunAsync(name);
