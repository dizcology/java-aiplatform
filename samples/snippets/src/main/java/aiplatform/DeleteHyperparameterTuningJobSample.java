...
public class DeleteHyperparameterTuningJobSample {
  ...
  public static void main(String[] args)
    ...
    deleteHyperparameterTuningJobSample(project, location, hyperparameterTuningJobId);
  }

  static void deleteHyperparameterTuningJobSample(
      String project, String location, String hyperparameterTuningJobId)
      throws IOException, ExecutionException, InterruptedException {
    ...
    try (JobServiceClient client = JobServiceClient.create(settings)) {
      ...
      OperationFuture<Empty, DeleteOperationMetadata> response =
          client.deleteHyperparameterTuningJobAsync(name);
