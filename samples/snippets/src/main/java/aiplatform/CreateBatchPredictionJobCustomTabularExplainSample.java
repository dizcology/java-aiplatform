...
// [START aiplatform_create_batch_prediction_job_custom_tabular_explain_sample]
...
public class CreateBatchPredictionJobCustomTabularExplainSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    createBatchPredictionJobCustomTabularExplainSample(
        project,
        location,
        displayName,
        modelId,
  ...
  static void createBatchPredictionJobCustomTabularExplainSample(
      String project,
      String location,
      String displayName,
      String modelId,
...
// [END aiplatform_create_batch_prediction_job_custom_tabular_explain_sample]
