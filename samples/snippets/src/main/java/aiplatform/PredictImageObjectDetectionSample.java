...
public class PredictImageObjectDetectionSample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    predictImageObjectDetectionSample(project, location, endpointId, filename);
  }

  static void predictImageObjectDetectionSample(
    ...
    try (PredictionServiceClient client = PredictionServiceClient.create(settings)) {
      ...
      ImageObjectDetectionPredictionInstance instance =
          ImageObjectDetectionPredictionInstance.newBuilder().setContent(encodedContent).build();
      ...
      ImageObjectDetectionPredictionParams parameters =
